...
@section('contenido')
    ...
    <div class="grid grid-3 mb-4">
        <a href="#" class="card">
            <div class="flex mb-2">
                <div class="avatar avatar-mini">A</div>
                <div>
    ...
    <div class="grid grid-3">
        <div class="home-grid-span-2">
            ...
            <div class="grid grid-4">
                <a href="#" class="card">
                    <div class="placeholder-img home-card-img">Peli A</div>
                </a>
                <a href="#" class="card">
                    <div class="placeholder-img home-card-img">Serie B</div>
                </a>
                <a href="#" class="card">
                    <div class="placeholder-img home-card-img">Peli C</div>
                </a>
                <a href="#" class="card">
                    <div class="placeholder-img home-card-img">Docu D</div>
                </a>
            </div>
        </div>
